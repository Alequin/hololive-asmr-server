...
export const mockYoutubeChannelDetails = (channelId, { response, responseStatus }) =>
  nock(`https://www.googleapis.com`)
    .get(`/youtube/v3/channels?key=${youtubeApiKey}&id=${channelId}&part=contentDetails,snippet`)
    .reply(responseStatus, response)
    .persist();

export const mockYoutubeVideosInPlaylist = (playlistId, { response, responseStatus }) =>
  nock(`https://www.googleapis.com`)
    .get(
